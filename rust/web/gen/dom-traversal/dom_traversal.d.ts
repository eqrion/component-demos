...
export type * as WebidlBaselineWeb from './interfaces/webidl-baseline-web.js'; // import webidl:baseline/web
export function run(nodeCount: number, iterations: number): void;
