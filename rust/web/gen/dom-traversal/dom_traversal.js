...
const _trampoline21 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="webidl:baseline/web", function="[method]node.first-child"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]node.first-child"][Instruction::Return]', {
    funcName: '[method]node.first-child',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline21.fnName = 'webidl:baseline/web#firstChild';
...
const _trampoline22 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="webidl:baseline/web", function="[method]node.next-sibling"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]node.next-sibling"][Instruction::Return]', {
    funcName: '[method]node.next-sibling',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline22.fnName = 'webidl:baseline/web#nextSibling';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./dom_traversal.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./dom_traversal.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[method]node.first-child': exports0['0'],
        '[method]node.next-sibling': exports0['1'],
