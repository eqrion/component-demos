"use components";
import { Document, Element, HtmlElement, Node, Text, TrustedHtml, TrustedScript, TrustedScriptUrl, Window, elementAsNode, getWindow, textAsNode } from '../../host/web-host.js';
...
_trampoline19.fnName = 'wasi:cli/stderr@0.2.3#getStderr';
...
_trampoline20.fnName = 'wasi:cli/stdin@0.2.3#getStdin';
...
_trampoline21.fnName = 'wasi:cli/stdout@0.2.3#getStdout';
...
_trampoline22.fnName = 'wasi:cli/exit@0.2.3#exit';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline23 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
  var handle1 = arg0;
...
_trampoline23.fnName = 'webidl:baseline/web#setAttribute';
...
_trampoline24.fnName = 'webidl:baseline/web#body';
...
_trampoline25.fnName = 'webidl:baseline/web#createElement';
...
_trampoline26.fnName = 'webidl:baseline/web#createTextNode';
...
_trampoline37.fnName = 'wasi:filesystem/preopens@0.2.3#getDirectories';
let exports3;
let exports1Run;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./todomvc.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./todomvc.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[resource-drop]document': trampoline9,
        '[resource-drop]element': trampoline6,
        '[resource-drop]html-element': trampoline7,
        '[resource-drop]node': trampoline8,
        '[resource-drop]text': trampoline10,
        '[resource-drop]trusted-html': trampoline11,
        '[resource-drop]trusted-script': trampoline12,
        '[resource-drop]trusted-script-url': trampoline13,
        '[resource-drop]window': trampoline14,
