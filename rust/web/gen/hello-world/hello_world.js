"use components";
import { Document, DomTokenList, Element, HtmlElement, Node, Text, Window, elementAsNode, getWindow, textAsNode } from '../../host/web-host.js';
...
const _trampoline3 = function(arg0) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="webidl:baseline/web", function="[method]element.class-list"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  if (!(ret instanceof DomTokenList)) {
    throw new TypeError('Resource error: Not a valid \"DomTokenList\" resource.');
  }
  var handle3 = ret[symbolRscHandle];
  if (!handle3) {
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]element.class-list"][Instruction::Return]', {
    funcName: '[method]element.class-list',
    paramCount: 1,
    async: false,
    postReturn: false
  });
...
_trampoline3.fnName = 'webidl:baseline/web#classList';
...
_trampoline22.fnName = 'webidl:baseline/web#body';
...
_trampoline23.fnName = 'webidl:baseline/web#createElement';
...
_trampoline24.fnName = 'webidl:baseline/web#createTextNode';
...
const _trampoline25 = function(arg0, arg1, arg2) {
  ...
  if (!rsc0) {
    rsc0 = Object.create(DomTokenList.prototype);
    Object.defineProperty(rsc0, symbolRscHandle, { writable: true, value: handle1});
    Object.defineProperty(rsc0, symbolRscRep, { writable: true, value: rep2});
  }
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]dom-token-list.add"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  curResourceBorrows = [];
  _debugLog('[iface="webidl:baseline/web", function="[method]dom-token-list.add"][Instruction::Return]', {
    funcName: '[method]dom-token-list.add',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline25.fnName = 'webidl:baseline/web#add';
...
const _trampoline36 = function(arg0) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    ...
    if (!handle1) {
      const rep = tuple0_0[symbolRscRep] || ++captureCnt10;
      captureTable10.set(rep, tuple0_0);
      handle1 = rscTableCreateOwn(handleTable10, rep);
    }
...
null,
{
  ...
  resultLowerFns: [_lowerFlatOwn({
    componentIdx: 0,
    lowerFn: 
    function lowerImportedOwnedHost_DomTokenList(obj) {
...
function trampoline7(handle) {
  ...
  if (handleEntry.own) {
    ...
    } else if (DomTokenList[symbolCabiDispose]) {
      DomTokenList[symbolCabiDispose](handleEntry.rep);
    }
  }
}
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./hello_world.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./hello_world.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        '[method]document.body': exports0['0'],
        '[method]document.create-element': exports0['1'],
        '[method]document.create-text-node': exports0['2'],
        '[method]dom-token-list.add': exports0['3'],
        '[method]element.append-child': trampoline2,
        '[method]element.class-list': trampoline3,
        '[method]html-element.append-child': trampoline0,
        '[method]window.document': trampoline1,
        '[resource-drop]document': trampoline11,
        '[resource-drop]dom-token-list': trampoline7,
