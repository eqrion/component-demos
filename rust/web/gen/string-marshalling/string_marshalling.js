"use components";
import { Document, Element, HtmlElement, Node, Text, Window, elementAsNode, getWindow, now, textAsNode } from '../../host/web-host.js';
...
_trampoline17.fnName = 'wasi:cli/stderr@0.2.3#getStderr';
...
_trampoline18.fnName = 'wasi:cli/stdin@0.2.3#getStdin';
...
_trampoline19.fnName = 'wasi:cli/stdout@0.2.3#getStdout';
...
_trampoline20.fnName = 'wasi:cli/exit@0.2.3#exit';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline21 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="webidl:baseline/web", function="[method]node.text-content"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]node.text-content"][Instruction::Return]', {
    funcName: '[method]node.text-content',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline21.fnName = 'webidl:baseline/web#textContent';
...
const _trampoline22 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]node.set-text-content"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => rsc0.setTextContent(result3),
    })
    ;
  } catch (err) {
  ...
  curResourceBorrows = [];
  _debugLog('[iface="webidl:baseline/web", function="[method]node.set-text-content"][Instruction::Return]', {
    funcName: '[method]node.set-text-content',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline22.fnName = 'webidl:baseline/web#setTextContent';
...
_trampoline23.fnName = 'webidl:baseline/web#body';
...
_trampoline24.fnName = 'webidl:baseline/web#createElement';
...
_trampoline25.fnName = 'webidl:baseline/web#createTextNode';
...
_trampoline26.fnName = 'wasi:cli/environment@0.2.3#getEnvironment';
...
_trampoline27.fnName = 'wasi:filesystem/types@0.2.3#filesystemErrorCode';
...
_trampoline28.fnName = 'wasi:filesystem/types@0.2.3#writeViaStream';
...
_trampoline29.fnName = 'wasi:filesystem/types@0.2.3#appendViaStream';
...
_trampoline30.fnName = 'wasi:filesystem/types@0.2.3#getType';
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.3#stat';
...
_trampoline32.fnName = 'wasi:io/streams@0.2.3#checkWrite';
...
_trampoline33.fnName = 'wasi:io/streams@0.2.3#write';
...
_trampoline34.fnName = 'wasi:io/streams@0.2.3#blockingFlush';
...
_trampoline35.fnName = 'wasi:io/streams@0.2.3#blockingWriteAndFlush';
...
const _trampoline36 = function(arg0) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    ...
    if (!handle1) {
      const rep = tuple0_0[symbolRscRep] || ++captureCnt9;
      captureTable9.set(rep, tuple0_0);
...
_trampoline36.fnName = 'wasi:filesystem/preopens@0.2.3#getDirectories';
let exports3;
let exports1Run;
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 7),_liftFlatList({
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./string_marshalling.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./string_marshalling.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[method]node.set-text-content': exports0['1'],
        '[method]node.text-content': exports0['0'],
        ...
        '[resource-drop]window': trampoline12,
