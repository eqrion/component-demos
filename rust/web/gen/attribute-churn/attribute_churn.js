...
const _trampoline25 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]element.set-attributes"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  curResourceBorrows = [];
  _debugLog('[iface="webidl:baseline/web", function="[method]element.set-attributes"][Instruction::Return]', {
    funcName: '[method]element.set-attributes',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline25.fnName = 'webidl:baseline/web#setAttributes';
...
_trampoline26.fnName = 'webidl:baseline/web#body';
...
_trampoline27.fnName = 'webidl:baseline/web#createElement';
...
_trampoline28.fnName = 'webidl:baseline/web#createTextNode';
...
_trampoline29.fnName = 'wasi:cli/environment@0.2.3#getEnvironment';
...
_trampoline33.fnName = 'wasi:filesystem/types@0.2.3#getType';
...
_trampoline35.fnName = 'wasi:io/streams@0.2.3#checkWrite';
...
_trampoline36.fnName = 'wasi:io/streams@0.2.3#write';
...
_trampoline37.fnName = 'wasi:io/streams@0.2.3#blockingFlush';
...
_trampoline38.fnName = 'wasi:io/streams@0.2.3#blockingWriteAndFlush';
...
_trampoline39.fnName = 'wasi:filesystem/preopens@0.2.3#getDirectories';
let exports3;
let exports1Run;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./attribute_churn.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./attribute_churn.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        '[method]document.body': exports0['2'],
        '[method]document.create-element': exports0['3'],
        '[method]document.create-text-node': exports0['4'],
        '[method]element.append-child': trampoline2,
        '[method]element.set-attribute': exports0['0'],
        '[method]element.set-attributes': exports0['1'],
