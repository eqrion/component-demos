"use components";
import { Document, Element, HtmlElement, Node, Text, TrustedHtml, TrustedScript, TrustedScriptUrl, Window, elementAsNode, getWindow, now, textAsNode } from '../../host/web-host.js';
...
_trampoline2.fnName = 'webidl:baseline/web#appendChild';

const _trampoline3 = function() {
...
_trampoline3.fnName = 'webidl:baseline/web#getWindow';
...
_trampoline4.fnName = 'webidl:baseline/web#textAsNode';
...
_trampoline5.fnName = 'webidl:baseline/web#elementAsNode';
...
_trampoline6.fnName = 'webidl:baseline/web#now';
let exports1;
...
_trampoline20.fnName = 'wasi:cli/stderr@0.2.3#getStderr';
...
_trampoline21.fnName = 'wasi:cli/stdin@0.2.3#getStdin';
...
_trampoline22.fnName = 'wasi:cli/stdout@0.2.3#getStdout';
...
_trampoline23.fnName = 'wasi:cli/exit@0.2.3#exit';
let exports2;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline24 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
  var handle1 = arg0;
      ...
      switch (arg4) {
        ...
        case 1: {
          ...
          if (!rsc7) {
            ...
            captureTable6.delete(rep9);
          }
          rscTableRemove(handleTable6, handle8);
          variant13= {
            tag: 'trusted-script',
            val: rsc7
          };
        ...
        case 2: {
          ...
          var rep12 = handleTable7[(handle11 << 1) + 1] & ~T_FLAG;
          var rsc10 = captureTable7.get(rep12);
          if (!rsc10) {
            ...
            captureTable7.delete(rep12);
          }
          rscTableRemove(handleTable7, handle11);
          variant13= {
...
_trampoline24.fnName = 'webidl:baseline/web#setAttribute';
...
_trampoline25.fnName = 'webidl:baseline/web#body';
...
_trampoline26.fnName = 'webidl:baseline/web#createElement';

const _trampoline27 = function(arg0, arg1, arg2) {
  var handle1 = arg0;
...
_trampoline27.fnName = 'webidl:baseline/web#createTextNode';
...
const _trampoline28 = function(arg0, arg1, arg2, arg3) {
  ...
  var len3 = arg2;
  var result3 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  _debugLog('[iface="webidl:baseline/web", function="[method]document.get-element-by-id"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => rsc0.getElementById(result3),
    })
    ;
  } catch (err) {
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]document.get-element-by-id"][Instruction::Return]', {
    funcName: '[method]document.get-element-by-id',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline28.fnName = 'webidl:baseline/web#getElementById';
...
const _trampoline29 = function(arg0, arg1, arg2, arg3) {
  ...
  var len3 = arg2;
  var result3 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  _debugLog('[iface="webidl:baseline/web", function="[method]document.get-elements-by-class-name"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  const createTask = () => {
    const results = createNewCurrentTask({
      componentIdx: -1,
      isAsync: false,
      entryFnName: 'getElementsByClassName',
      getCallbackFn: () => null,
      callbackFnName: null,
      errHandling: 'none',
      callingWasmExport: false,
  ...
  try {
    ret = _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => rsc0.getElementsByClassName(result3),
    })
    ;
  } catch (err) {
  ...
  var result5 = realloc0(0, 0, 4, len5 * 4);
  for (let i = 0; i < vec5.length; i++) {
    const e = vec5[i];
    const base = result5 + i * 4;
    if (!(e instanceof Element)) {
      throw new TypeError('Resource error: Not a valid \"Element\" resource.');
    }
    var handle4 = e[symbolRscHandle];
    ...
    dataView(memory0).setInt32(base + 0, handle4, true);
  }
  dataView(memory0).setUint32(arg3 + 4, len5, true);
  dataView(memory0).setUint32(arg3 + 0, result5, true);
  _debugLog('[iface="webidl:baseline/web", function="[method]document.get-elements-by-class-name"][Instruction::Return]', {
    funcName: '[method]document.get-elements-by-class-name',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline29.fnName = 'webidl:baseline/web#getElementsByClassName';
...
_trampoline30.fnName = 'wasi:cli/environment@0.2.3#getEnvironment';
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.3#filesystemErrorCode';
...
_trampoline32.fnName = 'wasi:filesystem/types@0.2.3#writeViaStream';
...
_trampoline33.fnName = 'wasi:filesystem/types@0.2.3#appendViaStream';
...
_trampoline34.fnName = 'wasi:filesystem/types@0.2.3#getType';
...
_trampoline35.fnName = 'wasi:filesystem/types@0.2.3#stat';
...
_trampoline36.fnName = 'wasi:io/streams@0.2.3#checkWrite';
    ...
    switch (variant5.tag) {
      case 'last-operation-failed': {
        ...
        if (!handle4) {
          const rep = e[symbolRscRep] || ++captureCnt9;
          captureTable9.set(rep, e);
          handle4 = rscTableCreateOwn(handleTable9, rep);
        }
...
_trampoline37.fnName = 'wasi:io/streams@0.2.3#write';
...
_trampoline38.fnName = 'wasi:io/streams@0.2.3#blockingFlush';
...
_trampoline39.fnName = 'wasi:io/streams@0.2.3#blockingWriteAndFlush';
...
const _trampoline40 = function(arg0) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    ...
    if (!handle1) {
      const rep = tuple0_0[symbolRscRep] || ++captureCnt12;
      captureTable12.set(rep, tuple0_0);
...
_trampoline40.fnName = 'wasi:filesystem/preopens@0.2.3#getDirectories';
let exports3;
let exports1Run;
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 1),_liftFlatBorrow.bind(null, 4)],
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 2),_liftFlatBorrow.bind(null, 4)],
  resultLowerFns: [_lowerFlatOwn({
    componentIdx: 0,
    lowerFn: 
    function lowerImportedOwnedHost_Node(obj) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./dom_query.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./dom_query.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[method]document.get-element-by-id': exports0['4'],
        '[method]document.get-elements-by-class-name': exports0['5'],
        '[method]element.append-child': trampoline2,
        '[method]element.set-attribute': exports0['0'],
        '[method]html-element.append-child': trampoline0,
        '[method]window.document': trampoline1,
        '[resource-drop]document': trampoline10,
        '[resource-drop]element': trampoline7,
        '[resource-drop]html-element': trampoline8,
        '[resource-drop]node': trampoline9,
        '[resource-drop]text': trampoline11,
        '[resource-drop]trusted-html': trampoline12,
        '[resource-drop]trusted-script': trampoline13,
        '[resource-drop]trusted-script-url': trampoline14,
        '[resource-drop]window': trampoline15,
        'element-as-node': trampoline5,
        'get-window': trampoline3,
        now: trampoline6,
        'text-as-node': trampoline4,
      },
    }));
    ({ exports: exports2 } = yield instantiateCore(yield module1, {
      ...
      'wasi:filesystem/types@0.2.3': {
        ...
        '[resource-drop]descriptor': trampoline16,
      ...
      'wasi:io/streams@0.2.3': {
        ...
        '[resource-drop]input-stream': trampoline19,
