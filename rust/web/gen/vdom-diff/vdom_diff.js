...
const _trampoline0 = function(arg0) {
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]element.remove"] [Instruction::CallInterface] (sync, @ enter)');
  ...
  curResourceBorrows = [];
  _debugLog('[iface="webidl:baseline/web", function="[method]element.remove"][Instruction::Return]', {
    funcName: '[method]element.remove',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline0.fnName = 'webidl:baseline/web#remove';
...
_trampoline1.fnName = 'webidl:baseline/web#appendChild';
...
_trampoline2.fnName = 'webidl:baseline/web#document';
...
const _trampoline4 = function(arg0, arg1, arg2) {
  ...
  if (!rsc6) {
    rsc6 = Object.create(Node.prototype);
  ...
  _debugLog('[iface="webidl:baseline/web", function="[method]element.insert-before"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => rsc0.insertBefore(rsc3, rsc6),
    })
    ;
  } catch (err) {
  ...
  if (!handle9) {
    const rep = ret[symbolRscRep] || ++captureCnt4;
    captureTable4.set(rep, ret);
    handle9 = rscTableCreateOwn(handleTable4, rep);
  }
  
  _debugLog('[iface="webidl:baseline/web", function="[method]element.insert-before"][Instruction::Return]', {
    funcName: '[method]element.insert-before',
    paramCount: 1,
    async: false,
    postReturn: false
  });
  task.resolve([handle9]);
  task.exit();
  return handle9;
}
_trampoline4.fnName = 'webidl:baseline/web#insertBefore';
...
_trampoline23.fnName = 'webidl:baseline/web#setTextContent';
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 2),_liftFlatBorrow.bind(null, 4),_liftFlatBorrow.bind(null, 4)],
  resultLowerFns: [_lowerFlatOwn({
    componentIdx: 0,
    lowerFn: 
    function lowerImportedOwnedHost_Node(obj) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./vdom_diff.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./vdom_diff.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[method]element.insert-before': trampoline4,
        '[method]element.remove': trampoline0,
        '[method]html-element.append-child': trampoline1,
        '[method]node.set-text-content': exports0['0'],
        '[method]window.document': trampoline2,
        '[resource-drop]document': trampoline12,
        '[resource-drop]element': trampoline9,
        '[resource-drop]html-element': trampoline10,
        '[resource-drop]node': trampoline11,
        '[resource-drop]text': trampoline13,
