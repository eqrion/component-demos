...
_trampoline31.fnName = 'webidl:baseline/web#setFillStyle';
...
_trampoline32.fnName = 'wasi:cli/environment@0.2.3#getEnvironment';
...
_trampoline33.fnName = 'wasi:filesystem/types@0.2.3#filesystemErrorCode';
...
_trampoline34.fnName = 'wasi:filesystem/types@0.2.3#writeViaStream';
...
_trampoline35.fnName = 'wasi:filesystem/types@0.2.3#appendViaStream';
...
_trampoline36.fnName = 'wasi:filesystem/types@0.2.3#getType';
...
_trampoline37.fnName = 'wasi:filesystem/types@0.2.3#stat';
...
_trampoline38.fnName = 'wasi:io/streams@0.2.3#checkWrite';

const _trampoline39 = function(arg0, arg1, arg2, arg3) {
  var handle1 = arg0;
...
_trampoline39.fnName = 'wasi:io/streams@0.2.3#write';
...
_trampoline40.fnName = 'wasi:io/streams@0.2.3#blockingFlush';
...
_trampoline41.fnName = 'wasi:io/streams@0.2.3#blockingWriteAndFlush';
...
_trampoline42.fnName = 'wasi:filesystem/preopens@0.2.3#getDirectories';
let exports3;
let exports1Run;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./canvas_draw.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./canvas_draw.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'webidl:baseline/web': {
        ...
        '[method]canvas-rendering-context2d.set-fill-style': exports0['4'],
